...
<form method="POST" name="myForm" id="myForm" action="?pg=producao-terceiro2&filtro">
<div class="form-row">
...
<table class="table table-hover">
        ...
        $tecnicossql = $pdo->prepare("SELECT * FROM tecnicos WHERE id_tecnico='24' OR id_tecnico='16' ORDER BY nome ASC");
        $tecnicossql->execute();
...
echo "<script>location.href='?pg=producao-terceiro2&data=".$data."&data2=".$data2."'</script>"; 
} ?>