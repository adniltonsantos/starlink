...
<div class="panel panel-default">
  ...
  <ul class="list-group">
    ...
    <li class="list-group-item">
      ...
      <a href="?pg=cliente-agendar2&whats&id_cliente=<?php echo $linha['id_cliente'];?>"><button type="button" class="btn btn-success btn-sm">Whats APP</button></a>
      <a href="?pg=cliente-agendar2&sem-contato&id_cliente=<?php echo $linha['id_cliente'];?>" onclick="if (! confirm('Deseja marcar o cliente como Sem Contato ? ')) { return false; }"><button type="button" class="btn btn-warning btn-sm">Sem Contato</button></a>
      <a href="?pg=cliente-agendar2&cancelou&id_cliente=<?php echo $linha['id_cliente'];?>" onclick="if (! confirm('Deseja marcar o cliente como Cancelou ? ')) { return false; }"><button type="button" class="btn btn-danger btn-sm">Cancelou</button></a>
...
<?php echo $linha['cod_cliente']?> - <?php echo $linha['nomeCliente']?>
      ...
      <form method="POST" id="agendar<?php echo $linha['id_cliente'];?>" action="?pg=cliente-agendar2&update">
...
<?php echo $linha['cod_cliente']?> - <?php echo $linha['nomeCliente']?>
     ...
     <div style="padding:20px">
      ...
      <form method="POST" id="comentario<?php echo $linha['id_cliente'];?>" action="?pg=cliente-agendar2&comentario">
...
if (isset($_GET['update'])){
  ...
  echo "<script>location.href='?pg=cliente-agendar2'</script>";  
}
?>
