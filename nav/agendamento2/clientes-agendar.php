...
<table class="table table-hover">
    ...
    <td class="centro-table"><a href="?pg=clientes-agendar2&id_cliente=<?php echo $linha['id_cliente'];?>"><div aria-hidden="true" data-toggle="modal" data-target="#myModal<?php echo $linha['id_cliente']?>" class="glyphicon glyphicon-time"></div></td>
    ...
    <td class="centro-table"><a href="?pg=clientes-agendar2&cancelou&id_cliente=<?php echo $linha['id_cliente'];?>&tipo=<?php echo $_GET['tipo']?>"><div  onclick="if (! confirm('Deseja Cancelar o cliente com o código , <?php echo $linha['cod_cliente']; ?>')) { return false; }"class="glyphicon glyphicon-remove" title="Cancelou" data-toggle="tooltip"></div></td>
    </tr>
...
<div class="modal fade" id="myModal<?php echo $linha['id_cliente']?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST"  id="agendar<?php echo $linha['id_cliente'];?>" action="?pg=clientes-agendar2&update">
...
<?php echo $linha['cod_cliente']?> - <?php echo $linha['nomeCliente']?>
     ...
     <div style="padding:20px">
      ...
      <form method="POST" id="comentario<?php echo $linha['id_cliente'];?>" action="?pg=clientes-agendar2&comentario">
...
if (isset($_GET['cancelou'])){
    ...
    echo "<script>alert('Cliente Cancelado com Sucesso'); location.href='?pg=clientes-agendar2&selecionado&tipo=$tipo'</script>"; 
}
