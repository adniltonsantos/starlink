...
if (isset($_GET['comentario'])){
    ...
    echo "<script>location.href='?pg=cliente-sem-contato</script>";  
}
?>
...
<!-- Fecha Formulario-->
       ...
       <?php 
        ...
        $agendadosql = $pdo->prepare("SELECT *, nome as nomeCliente from clientes WHERE status_cliente='sem-contato' AND tipo='cond' ORDER BY data_cadastro ASC ");
...
<?php echo $linha['cod_cliente']?> - <?php echo $linha['nome']?>
      ...
      <form method="POST" id="agendar<?php echo $linha['id_cliente'];?>" action="?pg=cliente-sem-contato&update">
...
<?php echo $linha['cod_cliente']?> - <?php echo $linha['nomeCliente']?>
     ...
     <div style="padding:20px">
      ...
      <form method="POST" id="comentario<?php echo $linha['id_cliente'];?>" action="?pg=cliente-sem-contato&comentario">
