...
if (isset($_GET['comentario'])){
    ...
    echo "<script>location.href='?pg=cliente-reagendar2</script>";  
}
?>
...
<table class="table table-hover">
    ...
    <td class="centro-table"><a href="?pg=cliente-reagendar2&id_cliente=<?php echo $linha['id_cliente'];?>"><div aria-hidden="true" data-toggle="modal" data-target="#myModal<?php echo $linha['id_cliente']?>" class="glyphicon glyphicon-time"></div></td>
...
<div class="modal fade" id="myModal<?php echo $linha['id_cliente']?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" name="enviar" action="?pg=cliente-reagendar2&update">
...
<?php echo $linha['cod_cliente']?> - <?php echo $linha['nomeCliente']?>
     ...
     <div style="padding:20px">
      ...
      <form method="POST" id="comentario<?php echo $linha['id_cliente'];?>" action="?pg=cliente-reagendar2&comentario">
