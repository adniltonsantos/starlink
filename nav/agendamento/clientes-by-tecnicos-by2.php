...
{
var src = "?pg=clientes-by-tecnicos-by2&between&data=<?php echo $_GET['data'];?>&data2=<?php echo $_GET['data2'];?>&id_tecnico="+obj.value;
location.href = src;
}
</script>
...
<form method="POST" name="myForm" id="myForm" action="?pg=clientes-by-tecnicos-by2&filtro">
<div class="form-row">
...
<?php if (isset($_GET['between'])){ 
        ...
        <td>
          <?php if($linha['status_iclass'] == NULL){ ?>
            ...
            <a href="?pg=clientes-by-tecnicos-by2&iclass&os=<?php echo $linha['id_instalacao'];?>&data=<?php echo $_GET['data']; ?>&data2=<?php echo $_GET['data']; ?>&id_tecnico=<?php echo $_GET['id_tecnico']; ?>">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div style="padding:20px">
          <form method="POST" id="finalizar<?php echo $linha['id_instalacao'];?>" action="?pg=clientes-by-tecnicos-by2&finalizar">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div style="padding:20px">
          <form method="POST" id="motivo<?php echo $linha['id_instalacao'];?>" action="?pg=clientes-by-tecnicos-by2&resolucao">
            <input type="hidden" name="os" value="<?php echo $linha['id_instalacao'] ?>">
            <input type="hidden" name="data" value="<?php echo $_GET['data']?>">
            <input type="hidden" name="data2" value="<?php echo $_GET['data2']?>">
            <input type="hidden" name="pg_id_tecnico" value="<?php echo $_GET['id_tecnico']?>">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div style="padding:20px">
          ...
          <form method="POST" id="transferencia<?php echo $linha['id_instalacao'];?>" action="?pg=clientes-by-tecnicos-by2&transferencia">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="POST" id="reagendar<?php echo $linha['id_instalacao'];?>" action="?pg=clientes-by-tecnicos-by2&reagendar">
      <input type="hidden" name="os" value="<?php echo $linha['id_instalacao']?>">
      <input type="hidden" name="data" value="<?php echo $_GET['data']?>">
      <input type="hidden" name="data2" value="<?php echo $_GET['data2']?>">
      <input type="hidden" name="pg_id_tecnico" value="<?php echo $_GET['id_tecnico']?>">
...
<?php echo $linha['cod_cliente']?> - <?php echo $linha['nomeCliente']?>
     ...
     <div style="padding:20px">
      ...
      <form method="POST" id="comentario<?php echo $linha['id_cliente'];?>" action="?pg=clientes-by-tecnicos-by2&comentario">
...
echo "<script>location.href='?pg=clientes-by-tecnicos-by2&between&data=".$data."&data2=".$data2."&id_tecnico=".$pg_id_tecnico."'</script>"; 
} ?>
...
echo "<script>location.href='?pg=clientes-by-tecnicos-by2&between&data=".$data."&data2=".$data2."&id_tecnico=".$id_tecnico."'</script>"; 
} ?>
