...
<div class="panel panel-default">
  ...
  <ul class="list-group">
    ...
    <li class="list-group-item">
      ...
      <a href="?pg=cliente-agendar-setor01&sem-contato&id_cliente=<?php echo $linha['id_cliente'];?>" onclick="if (! confirm('Deseja marcar o cliente como Sem Contato ? ')) { return false; }"><button type="button" class="btn btn-warning btn-sm">Sem Contato</button></a>
      <a href="?pg=cliente-agendar-setor01&cancelou&id_cliente=<?php echo $linha['id_cliente'];?>" onclick="if (! confirm('Deseja marcar o cliente como Cancelou ? ')) { return false; }"><button type="button" class="btn btn-danger btn-sm">Cancelou</button></a>
