...
<div class="panel panel-default">
  ...
  <ul class="list-group">
    ...
    <li class="list-group-item">
      ...
      <a href="?pg=cliente-agendar-setor03&sem-contato&id_cliente=<?php echo $linha['id_cliente'];?>" onclick="if (! confirm('Deseja marcar o cliente como Sem Contato ? ')) { return false; }"><button type="button" class="btn btn-danger btn-sm">Sem Contato</button></a>
      </li>
