...
<legend>Clientes que estão  Cancelando</legend>
...
<!-- Fecha Formulario-->
       ...
       <?php 
        ...
        $agendadosql = $pdo->prepare("SELECT *, nome as nomeCliente from clientes WHERE status_cliente='cancelou' ORDER BY data_cadastro DESC ");
        ...
        <td>            
            <a href="?pg=cliente-cancelou-vendas&desativar&id_cliente=<?php echo $linha['id_cliente']?>">
...
<?php echo $linha['cod_cliente']?> - <?php echo $linha['nomeCliente']?>
     ...
     <div style="padding:20px">
      ...
      <form method="POST" id="comentario<?php echo $linha['id_cliente'];?>" action="?pg=cliente-cancelou-vendas&comentario">
...
if (isset($_GET['retornar'])){
    ...
    echo "<script>alert('Cliente  Retornado com Sucesso para o Setor de Agendamento'); location.href='?pg=cliente-cancelou-vendas'</script>";
}
?>
